var rule = {
    ...
    推荐: `js:
        let d = [{
            ...
            title: 'TVBox 订阅入口',
            img: '',
            desc: 'https://cdn.jsdelivr.net/gh/SakuraByteCore/subHub/tvbox.json',
            url: 'links'
        }];
        setResult(d);
    `,
    一级: `js:
        let cards = {
            ...
            links: [{
                ...
                url: 'https://cdn.jsdelivr.net/gh/SakuraByteCore/subHub/tvbox.json'
            }, {
                title: 'TVBox 备用链接 Fastly',
                img: '',
                desc: 'fastly.jsdelivr.net / main / tvbox.json',
                url: 'https://fastly.jsdelivr.net/gh/SakuraByteCore/subHub/tvbox.json'
            }, {
                title: 'TVBox 备用链接 Gcore',
                img: '',
                desc: 'gcore.jsdelivr.net / main / tvbox.json',
                url: 'https://gcore.jsdelivr.net/gh/SakuraByteCore/subHub/tvbox.json'
            }],
            outputs: [{
