var rule = {
    ...
    推荐: `js:
        let d = [{
            ...
            title: 'TVBox 订阅入口',
            img: '',
            desc: 'https://cdn.jsdelivr.net/gh/SakuraByteCore/subHub@main/tvbox.json',
            url: 'links'
        }];
        setResult(d);
    `,
    一级: `js:
        let cards = {
            ...
            links: [{
                title: 'TVBox 主订阅链接',
                img: '',
                desc: 'cdn.jsdelivr.net / main / tvbox.json',
                url: 'https://cdn.jsdelivr.net/gh/SakuraByteCore/subHub@main/tvbox.json'
            }, {
                title: 'TVBox 备用链接 Fastly',
                img: '',
                desc: 'fastly.jsdelivr.net / main / tvbox.json',
                url: 'https://fastly.jsdelivr.net/gh/SakuraByteCore/subHub@main/tvbox.json'
            }, {
                title: 'TVBox 备用链接 Gcore',
                img: '',
                desc: 'gcore.jsdelivr.net / main / tvbox.json',
                url: 'https://gcore.jsdelivr.net/gh/SakuraByteCore/subHub@main/tvbox.json'
            }],
            outputs: [{
                title: '当前输出：TVBox JSON',
                img: '',
                desc: '根目录 tvbox.json 会继续保留，避免破坏已经在用的订阅地址。',
                url: 'outputs'
            }],
            sources: [{
